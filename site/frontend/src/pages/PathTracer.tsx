...
export default function PathTracer() {
  ...
  // Split hops into rows of up to HOPS_PER_ROW (desktop zig-zag only)
  const rows: any[][] = []
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Form — responsive: stacked on mobile, single row on sm+ */}
      <GlassCard>
      ...
      {trace && (
        <>
          {!trace.found ? (
            ...
            <>
              {/* ══════════════════════════════════════════════════════════════
                  DESKTOP — horizontal zig-zag rows (lg and up)
                  ══════════════════════════════════════════════════════════ */}
                          ...
                          {displayedHops.map((hop: any, colIndex: number) => {
                            ...
                            return (
                              <React.Fragment key={hop.device_id}>
                                ...
                                >
                                  <div className="self-start text-[10px] font-bold text-white/20 group-hover:text-white/40 transition-colors">
                                    #{origIdx + 1}
                                  </div>
                                  ...
                                  return (
                                    <div className="flex-1 relative flex items-center min-w-[80px]">
                                      ...
                                      <div className="flex items-center w-full gap-1 px-2">
                                        ...
                                        {isReversed
                                          ? <ArrowLeft  size={10} className="text-white/20 flex-shrink-0" />
              ...
              {/* ══════════════════════════════════════════════════════════════
                  MOBILE — fully vertical list (below lg)
                  ══════════════════════════════════════════════════════════ */}
